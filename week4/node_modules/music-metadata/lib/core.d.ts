...
import { type AnyWebByteStream, type IFileInfo, type IRandomAccessTokenizer, type ITokenizer } from 'strtok3';
...
export { type IAudioMetadata, type IChapter, type ICommonTagsResult, type IFormat, type ILyricsTag, type IMetadataEvent, type IMetadataEventTag, type INativeTagDict, type IOptions, type IPicture, type IRatio, type ITag, LyricsContentType, TimestampFormat } from './type.js';
/**
 * Parse Web API File
